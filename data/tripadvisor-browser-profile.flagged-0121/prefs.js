...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1789335239);
user_pref("app.update.lastUpdateTime.background-update-timer", 1789335239);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1789335239);
user_pref("app.update.lastUpdateTime.region-update-timer", 1788866896);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1789335239);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1789335239);
user_pref("app.update.mode", 0);
user_pref("app.update.service.enabled", false);
user_pref("apz.content_response_timeout", 60000);
user_pref("browser.bookmarks.restore_default_bookmarks", false);
user_pref("browser.contentblocking.category", "custom");
user_pref("browser.contextual-services.contextId", "e6247a92-34e2-40ed-be3c-aebf3f604a6b");
user_pref("browser.contextual-services.contextId.timestamp-in-seconds", 1788866871);
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{116058ef-2af3-4054-9856-c2ea0a897834}");
...
user_pref("browser.sessionstore.upgradeBackup.latestBuildID", "20251001122343");
user_pref("browser.shell.checkDefaultBrowser", false);
user_pref("browser.startup.couldRestoreSession.count", 2);
user_pref("browser.startup.homepage", "about:blank");
user_pref("browser.startup.homepage_override.mstone", "ignore");
user_pref("browser.startup.lastColdStartupCheck", 1789336181);
...
user_pref("captchadetection.lastSubmission", 1789335);
user_pref("captivedetect.canonicalURL", "");
user_pref("datareporting.dau.cachedUsageProfileGroupID", "846a7245-c931-4cef-9f27-37512b36330a");
user_pref("datareporting.dau.cachedUsageProfileID", "dedb2358-1705-4c28-b58c-fbebfd1a25c4");
...
user_pref("extensions.lastAppBuildId", "20251001122343");
...
user_pref("extensions.webextensions.uuids", "{\"formautofill@mozilla.org\":\"5ce9aaa3-447c-44be-9f78-b8c18de39de6\",\"newtab@mozilla.org\":\"0a6ef24d-d53a-460d-9fb9-7ca440c01996\",\"pictureinpicture@mozilla.org\":\"3d8fecb7-87d4-48c5-a661-5a22ab006f7b\",\"addons-search-detection@mozilla.com\":\"e7547ec1-3056-4f83-b4e8-22204cb5c252\",\"webcompat@mozilla.org\":\"9a310967-e580-48bf-b3e8-4eafebbc122d\",\"default-theme@mozilla.org\":\"5d9c274f-6b3f-409e-94c0-28aa8deb20a2\"}");
...
user_pref("idle.lastDailyNotification", 1789335420);
...
user_pref("media.gmp-manager.buildID", "20251001122343");
user_pref("media.gmp-manager.lastCheck", 1789335268);
user_pref("media.gmp-manager.lastEmptyCheck", 1789335268);
...
user_pref("nimbus.profileId", "f13e2a90-daf5-4d16-8df6-f4a52e8e2591");
user_pref("pdfjs.disabled", true);
user_pref("pdfjs.enabledCache.state", false);
user_pref("permissions.isolateBy.userContext", true);
user_pref("places.database.lastMaintenance", 1788885434);
user_pref("plugin.state.flash", 0);
user_pref("privacy.bounceTrackingProtection.hasMigratedUserActivationData", true);
user_pref("privacy.clearOnShutdown_v2.formdata", true);
user_pref("privacy.purge_trackers.date_in_cookie_database", "0");
user_pref("privacy.purge_trackers.last_purge", "1789335420605");
...
user_pref("storage.vacuum.last.content-prefs.sqlite", 1789045386);
user_pref("storage.vacuum.last.index", 2);
user_pref("storage.vacuum.last.places.sqlite", 1788885434);
user_pref("toolkit.cosmeticAnimations.enabled", false);
user_pref("toolkit.profiles.storeID", "0e504111");
user_pref("toolkit.shutdown.fastShutdownStage", 3);
user_pref("toolkit.startup.last_success", 1789336177);
...
user_pref("toolkit.telemetry.previousBuildID", "20251001122343");
