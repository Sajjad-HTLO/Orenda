...
/**
 * JDBC batch writer for muze.gov.tr-sourced museum POIs.
 * <p>
 * Uses PostGIS UPSERT on {@code (osm_id, osm_type)}. Government-sourced POIs
 * use negative hash of SectionId as osm_id and 'G' as osm_type.
 * Sets {@code data_sources = ARRAY['muzegov']}.
 */
@Slf4j
@Component
@RequiredArgsConstructor
public class MuzeGovTrJdbcItemWriter implements ItemWriter<PoiEntity> {
    ...
    private static final String UPSERT = """
            INSERT INTO poi (
                ...
                NULL,
                ?, ARRAY['muzegov']::text[], ?::jsonb, false
            )
    ...
    public void write(Chunk<? extends PoiEntity> chunk) throws Exception {
        ...
        log.info("Wrote/updated {} muze.gov.tr museum POIs", items.size());
    }
}